...
ALLOWED_HOSTS = ['15.228.49.83', '127.0.0.1']
...
AWS_STORAGE_BUCKET_NAME = 'fotografias-alura-space-jardiel'
...
# STATIC_URL = f'setup/static/'

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'setup/static')
]

STATIC_ROOT = os.path.join('setup/static', 'static')
